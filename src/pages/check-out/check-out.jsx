...
import Contents from '@/pages/check-out/components/contents';
import Steps from '@/components/steps/steps';
import useScript from 'react-script-hook';

import { useFormik } from 'formik';
import { useContext, useEffect, useState } from 'react';
import { updateItem } from '@/apis/cart-service';
...
import { saveOrder } from '@/apis/order-service';
import { getProvince, getDistrict, getWard, getFee } from '@/apis/ghn-service';
import { StoreContext } from '@/contexts/store-provider';
import { cancelOrder } from '@/apis/payos-service';
