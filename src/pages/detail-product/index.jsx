...
import InformationProduct from '@/pages/detail-product/components/informartion';
import ReviewProduct from '@/pages/detail-product/components/review';
import MyFooter from '@/components/footer/footer';
import SliderCommon from '@/components/slider-common/slider-common';
import ReactImageMagnifier from 'simple-image-magnifier/react';
import Size from '@/components/product-item/size/size';
import Color from '@/components/product-item/color/color';
